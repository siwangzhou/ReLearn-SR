...
def create_dataset(dataset_opt):
    ...
    if mode == 'GT': # load HR_mod32 image and generate LR on-the-fly
        from data.GT_dataset import GTDataset as D
        dataset = D(dataset_opt)
    elif mode == 'GTLQ': # load generated HR_mod32-LR image pairs
        from data.GTLQ_dataset import GTLQDataset as D
        dataset = D(dataset_opt)
    elif mode == 'GTLQx': # load generated HR_mod32-LR image pairs, and replace with x4
        ...
        dataset = D(dataset_opt)
    elif mode == 'GTLQnpy': # load generated HR_mod32-LR image pairs
